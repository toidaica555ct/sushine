    ...
    <div class="wrapper">
        ...
        <header class="main-header">
            ...
            <a href="public/index2.html" class="logo">
                ...
                <span class="logo-lg"><b>Sun</b>Shine</span>
            </a>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                          ...
                          <ul class="treeview-menu">
                            <li class="active"><a href="simple.html"><i class="fa fa-circle-o"></i> Danh sách loại sản phẩm</a></li>
                            <li ><a href="data.html"><i class="fa fa-circle-o"></i>Danh sách chủ đề</a></li>
                            <li ><a href="data.html"><i class="fa fa-circle-o"></i>Danh sách sản phẩm</a></li>
                          </ul>
                        </li>
